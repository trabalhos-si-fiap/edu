...
| **Entrega** | [docs/demo-roteiro.md](docs/demo-roteiro.md) | `make demo`: dirige o app no Android pelo roteiro inteiro da apresentacao, com contas de staff idempotentes; `make demo-web`: o painel web num Chromium visivel |
...
| | [docs/back-end/admin-panel.md](docs/back-end/admin-panel.md) | Documento histórico: painel SQLAdmin do monolito, apagado na spec A |
